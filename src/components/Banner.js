function Banner({ title, cta, first }) {
  return (
    <section
      className={`mt-12 ${first ? `bg-[url('/images/banner/banner-m.jpg')] xs:bg-[url('/images/banner/banner.jpg')]` : `bg-[url('/images/banner/banner2-m.jpg')] xs:bg-[url('/images/banner/banner2.jpg')]`} bg-center bg-cover py-24 p-12 aspect-[0.75/1] xs:aspect-auto !font-Nunito-Sans rounded-2xl`}
    >
