function Footer() {
  ...
  return (
    <footer className="mt-6 py-12 px-6 sm:p-14 xl:px-40 !font-Nunito-Sans bg-[#1e1e38] text-gray-400 selection:bg-airbnb_red selection:text-white antialiased">
      <div className="grid sm:grid-cols-[repeat(auto-fit,_minmax(141px,_1fr))] gap-6">
        {content("About", [
          "How Airbnb works",
          "Newsroom",
          "Airbnb 2021",
      ...
      <div className="mt-12 pt-12 flex flex-col sm:flex-row space-y-6 sm:space-y-0 sm:space-x-8 justify-center items-center text-center border-t border-solid border-gray-600">
        <svg className="h-8 text-airbnb_red" xmlns="http://www.w3.org/2000/svg" viewBox="329.775 439.999 320.426 100.002" >
          <path
        ...
        <span>
          ...
          <a
            href="https://github.com/rajdeep-ghosh/airbnb-clone"
            target="_blank"
            rel="noreferrer"
